...
let spaceship = { x: 400, y: 550, width: 50, height: 50, dx: 0, dy: 0, speed: 5 };
let enemyShip = { x: 400, y: 50, width: 50, height: 50, dx: 2 };
...
function drawEnemyShip() {
    ctx.drawImage(enemyImg, enemyShip.x, enemyShip.y, enemyShip.width, enemyShip.height);
}
